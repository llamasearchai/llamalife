# Contributing to LlamaLife

Thank you for your interest in contributing to LlamaLife! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaLife:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamalife.git
   cd llamalife
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamalife.git
   ```
...
By contributing to LlamaLife, you agree that your contributions will be licensed under the project's MIT License.
